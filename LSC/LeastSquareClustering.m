function Cluster = LeastSquareClustering(A,Gamma,n0,epsilon,t,reject)
...
% SingleClusterPursuit is removed. 
% ======================================================================
...
[Cluster,~] = LeastSquareClusterPursuit(L,Gamma,Omega,n0,reject);
end